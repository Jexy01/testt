...
router.register('apiview_get_post', ProductViewSet, basename='products')
...
urlpatterns = [
    ...
    path('generic_post/', ProductCreateGenericsView.as_view()),
    path('generic_get_post/', ProductListCreateCenericView.as_view()),
